...
void initErrorProcessing() {
  ...
  niceTokenNameMap["leftCurlBrac"] = (char *) "\'{\'";
  niceTokenNameMap["leftBrac"] = (char *) "\'(\'";
  niceTokenNameMap["leftSquareBrac"]=(char *) "\'[\'";
  ...
  niceTokenNameMap["PER"] = (char *) "\'%\'";
  niceTokenNameMap["RETURN"] = (char *)"\"return\"";
  niceTokenNameMap["rightBrac"]= (char *) "\')\'";
  niceTokenNameMap["rightSquareBrac"]=(char *) "\']\'";
  niceTokenNameMap["rightCurlBrac"] = (char *)"\'}\'";
  ...
  niceTokenNameMap["ERROR"]= (char *) "I don't know";
  niceTokenNameMap["WARNCHAR"]=(char *) "Warn";
}
...
void yyerror(const char *msg)
{
  ...
  // print components
  char * temp = strdup("I don't know");
  if(strcmp(strs[3], temp)==0){
    //    printf("I dont' know\n");
    printf("ERROR(%d): Invalid or misplaced input character: \'\'. Character Ignored. \n", line);
  }else{
